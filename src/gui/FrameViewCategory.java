...
public class FrameViewCategory extends JFrame {
    ...
    FrameViewCategory(Course course, String category) {
        ...
        JPanel panel_2 = new JPanel(); {
            ...
            Object[][] gradeData = new Object[students.size()][columnNames.length];
            ...
            for (int i = 0; i < tableGrades.getColumnCount(); i++) {
                if (i > 0) {
                    int assignmentIndex = i - 1;
                    if (!course.getAssignments().get(assignmentIndex).getCategory().equals(category)) {
                        tableGrades.getColumnModel().getColumn(i).setMinWidth(0);
                        tableGrades.getColumnModel().getColumn(i).setMaxWidth(0);
                    }
                }
